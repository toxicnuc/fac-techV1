...
public class SilverOreBlockBlock extends FactechElements.ModElement {
	@ObjectHolder("factech:silveroreblock")
	public static final Block block = null;
	public SilverOreBlockBlock(FactechElements instance) {
		super(instance, 20);
	}
