...
public class SiliconOreBlockBlock extends FactechElements.ModElement {
	@ObjectHolder("factech:siliconoreblock")
	public static final Block block = null;
	public SiliconOreBlockBlock(FactechElements instance) {
		super(instance, 8);
	}
