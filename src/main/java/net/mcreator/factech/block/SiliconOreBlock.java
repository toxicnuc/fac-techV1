...
import net.mcreator.factech.item.SiliconGemItem;
...
public class SiliconOreBlock extends FactechElements.ModElement {
	@ObjectHolder("factech:siliconore")
	public static final Block block = null;
	public SiliconOreBlock(FactechElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SiliconGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("siliconore", "siliconore", blockAt -> {
