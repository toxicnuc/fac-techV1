...
public class EarthgemItem extends FactechElements.ModElement {
	@ObjectHolder("factech:earthgem")
	public static final Item block = null;
	public EarthgemItem(FactechElements instance) {
		super(instance, 35);
	}
