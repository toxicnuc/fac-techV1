...
public class WaterGemItem extends FactechElements.ModElement {
	@ObjectHolder("factech:watergem")
	public static final Item block = null;
	public WaterGemItem(FactechElements instance) {
		super(instance, 36);
	}
