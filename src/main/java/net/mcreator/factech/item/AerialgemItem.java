...
public class AerialgemItem extends FactechElements.ModElement {
	@ObjectHolder("factech:aerialgem")
	public static final Item block = null;
	public AerialgemItem(FactechElements instance) {
		super(instance, 37);
	}
